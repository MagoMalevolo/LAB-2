...
//ol.proj.get("EPSG:32718").setExtent([676939.815280, 5920447.279365, 679197.417577, 5922161.274793]);
var wms_layers = [];
...
lyr_ConceMetrop_UTM_1.set('fieldLabels', {'CUT_REG': 'inline label - always visible', 'CUT_PROV': 'inline label - always visible', 'CUT_COM': 'inline label - always visible', 'REGION': 'inline label - always visible', 'PROVINCIA': 'inline label - always visible', 'COMUNA': 'inline label - always visible', 'SUPERFICIE': 'inline label - always visible', });
lyr_Barrios_Selec_2.set('fieldLabels', {'Id': 'inline label - always visible', 'Nombre': 'inline label - always visible', 'Area': 'inline label - always visible', 'hab_m2': 'inline label - always visible', 'Sum_Poblac': 'inline label - always visible', 'av_hab': 'inline label - always visible', 'Long_tLic': 'inline label - always visible', 'Long_tNLic': 'inline label - always visible', 'Suma_Trans': 'inline label - always visible', 'porc_cober': 'inline label - always visible', 'Distance': 'inline label - always visible', 'LongcicloK': 'inline label - always visible', 'Long_rvial': 'inline label - always visible', });
